            ...
            if modulo_selecionado:
                ...
                with st.form(key=f"form_cadastro_v_{st.session_state.versao_formulario}", clear_on_submit=False):
                    ...
                    if is_completo:
                        ...
                        lbl_n1 = "Nome Completo Titular 1:" if modulo_selecionado == "PIEPE" else "Nome Avaliador Titular 1:"
                        lbl_n2 = "Nome Completo Titular 2:" if modulo_selecionado == "PIEPE" else "Nome Avaliador Titular 2:"
...
# ==========================================
# PAINEL DO PROFESSOR (CONTEXTUAL)
# ==========================================
def tela_professor():
    exibir_sucesso_pendente()
    col_titulo, col_logout = st.columns([4, 1])
